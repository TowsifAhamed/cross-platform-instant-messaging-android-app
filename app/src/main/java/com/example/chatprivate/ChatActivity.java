package com.example.chatprivate;
...
import com.example.chatprivate.Chat.ChatObject;
import com.example.chatprivate.Chat.MediaAdapter;
import com.example.chatprivate.Chat.MessageAdapter;
import com.example.chatprivate.Chat.MessageObject;
import com.example.chatprivate.User.UserObject;
import com.example.chatprivate.Utils.SendNotification;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void sendMessage(){
        ...
        final String messageId = mChatMessagesDb.push().getKey();
        ...
        DatabaseReference UserIDNameDB = FirebaseDatabase.getInstance().getReference("user").child(UserID).child("name");
        final ArrayList<String> UserIDName = new ArrayList<String>();
        UserIDNameDB.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                // This method is called once with the initial value and again
                // whenever data at this location is updated.
                String UserIDName = dataSnapshot.getValue().toString();
                //Toast toast = Toast.makeText(getApplicationContext(), UserIDName, Toast.LENGTH_SHORT);
                //toast.show();
                final Map newMessageMap = new HashMap<>();
                newMessageMap.put("creator", UserIDName);
